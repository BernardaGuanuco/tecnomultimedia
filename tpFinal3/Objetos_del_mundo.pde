...
void objetos() {
  ...
  objeto4.inicializar(668, 67, 3, "fisica");
  mundo.add(objeto4);

  Objetos objeto5 = new Objetos(27, 40);
  objeto5.inicializar(600, 50, 5, "flecha1");
  mundo.add(objeto5);

  Objetos objeto6 = new Objetos(50, 50);
  objeto6.inicializar(508, 80, 4, "iman");
  mundo.add(objeto6);

  Objetos objeto7 = new Objetos(160, 48);
  objeto7.inicializar(170, 350, 6, "osc");
  mundo.add(objeto7);
  ...
  objeto15.inicializar(600, 80, 14, "flecha2");
  //mundo.add(objeto15);
  ...
  objeto18.inicializar(600,220, 17, "tateti1");
  mundo.add(objeto18);
  ...
  objeto29.inicializar(100, 235, 34, "pendulo");
  mundo.add(objeto29);
  Objetos objeto30 = new Objetos(142, 26);
  objeto30.inicializar(400,250, 35, "soporteP");
  mundo.add(objeto30);
  FCircle bola = new FCircle(30);
  bola.setPosition(300, 350);
